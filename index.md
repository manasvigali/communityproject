...
<section class="hero">
  <div class="container hero-inner">
    <div class="hero-copy">
      ...
      <div class="btn-group">
        <a class="btn primary" href="{{ site.baseurl }}/learning.html">
          <span>&#9733;</span> Start Learning
        </a>
        <a class="btn ghost" href="{{ site.baseurl }}/quiz.html">
...
<section class="features-section container">
  ...
  <div class="features-grid">
    <a href="{{ site.baseurl }}/learning.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
    ...
    <a href="{{ site.baseurl }}plans.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
      <span class="feature-icon">&#128200;</span>
    ...
    <a href="{{ site.baseurl }}ideas.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
      <span class="feature-icon">&#128161;</span>
    ...
    <a href="{{ site.baseurl }}/quiz.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
      <span class="feature-icon">&#9745;</span>
      <h3>Interactive Quiz</h3>
      <p>Test your knowledge with 20 questions across 3 difficulty levels. Get instant feedback and track your progress.</p>
    </a>

    <a href="{{ site.baseurl }}faq.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
      <span class="feature-icon">&#128172;</span>
      <h3>FAQ & Guides</h3>
      <p>30+ answered questions about teen investing, apps, safety, and student-specific financial guidance.</p>
    </a>

    <a href="{{ site.baseurl }}about.html" class="feature-card fade-up" style="text-decoration:none;color:inherit;">
      <span class="feature-icon">&#127759;</span>
...
<section class="content-page container text-center" style="padding-top:3rem;">
  <div style="background: var(--gradient-card); border: 1px solid var(--border-subtle); border-radius: var(--radius-xl); padding: 3rem; max-width: 700px; margin: 0 auto;">
    ...
    <div class="btn-group" style="justify-content:center;">
      <a class="btn primary" href="{{ site.baseurl }}/learning.html">Begin Learning</a>
      <a class="btn ghost" href="{{ site.baseurl }}ideas.html">Browse Ideas</a>
    </div>
  </div>
</section>
